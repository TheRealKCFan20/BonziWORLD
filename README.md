...
**This original repository was discontinued due to any damages and/or script kiddies for causing the server to hacked and/or crash (e.g. [the samsung fun club virus script](https://pastebin.com/E5qeGBHR)). On this day, *We will be experience on fixing between the bugs, mistake issues and a crash issue on the original server.* Therefore, we will not be presenting on the fixing things in the original server.**
...
```
git clone https://github.com/TheRealKCFan20/BonziWORLD
cd BonziWORLD
```
