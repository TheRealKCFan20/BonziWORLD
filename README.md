...
**This original repository has been discontinued due to any damages for causing the server to crash. On this day, *We will be experience on fixing between the bugs and mistakes on the original server.* Therefore, we will not be presenting on the fixing things in the original server.**
