...
```
git clone -b 1.6.0 https://github.com/TheRealKCFan20/BonziWORLD
cd BonziWORLD
```
...
## Disclaimer
I'm not responsible if you screw up anything with your computer while setting this up. I have no idea how you would, but someone will find a way. I also will not provide support for installing dependencies. If you have everything installed properly, the above commands will work. The creators will probably fixing the files, Please wait for new updates.
